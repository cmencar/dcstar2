...
toolbox.register("mutate", tools.mutGaussian, mu=0.1, sigma=1, indpb=0.1)
toolbox.register("mate", tools.cxUniform, indpb=0.6)
toolbox.register("select", tools.selTournament, tournsize=20)
toolbox.register("evaluate", step_f)
...
def evalue(i):
    ...
    while j in range(8):
        ...
        algorithms.eaSimple(pop, toolbox, cxpb=CR[j], mutpb=0.1, ngen=NGEN, stats=stats,
                            halloffame=hof)
