...
class DCStarProblem(Problem):
    ...
    def estimate_cost(self, node):
        ...
        return first_level_priority, second_level_priority, third_level_priority#, fourth_level_priority#, fifth_level_priority
    ...
    def __initialize_gg(self, gg_parameters):
        ...
        # mutation_rate = 0.1
        # mutation_rate = 0.9
        # TODO da rimuovere dopo valutazione andamento fitness
        print(mutation_rate)
