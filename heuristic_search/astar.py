...
class AStar:
    ...
    def __init__(self, points_list, m_d=0, M_d=1):
        ...
        # generate an individual using DGG object
        self.genetic_guide_individual = self.__generate_gg_individual()
    ...
    def __generate_gg_individual(self):
        ...
        if hbs.get_impure_hyperboxes_number() != 0:
            print("Impure DGG individual generated, purification in process")
            found = False
            successors = individual.get_successors()
            while not found:
